      ...
      <div className="relative z-10 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Set and manage feeding, walking, and vet visit reminders for your
            pets
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reminders.map((reminder) => (
            <Card
              key={reminder.id}
              className={`bg-white/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-l-4 ${
                reminder.type === "feed"
                  ? "border-l-green-400"
                  : reminder.type === "walk"
                    ? "border-l-blue-400"
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center shadow-lg">
                    <img
                      src={
                        petTypeImages[
                          reminder.type as keyof typeof petTypeImages
                        ]
                      }
                      alt={reminder.type}
