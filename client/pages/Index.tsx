...
export default function Index() {
  ...
  const recentActivities = [
    {
      type: "reminder",
      text: "Fed Buddy - Morning meal",
      time: "2 hours ago",
      icon: "🍽️",
    },
    {
      type: "exercise",
      text: "Walked Luna for 30 minutes",
      time: "5 hours ago",
      icon: "🚶",
    },
    {
      type: "photo",
      text: "Added new photo of Whiskers",
      time: "1 day ago",
      icon: "📸",
    },
    {
      type: "vet",
      text: "Scheduled vet appointment for Max",
      time: "2 days ago",
      icon: "🏥",
    },
    {
      type: "training",
      text: "Buddy learned 'high-five' command",
      time: "3 days ago",
      icon: "🎾",
    },
  ];
  ...
  const upcomingEvents = [
    {
      event: "Vet Appointment - Luna",
      date: "Tomorrow, 2:00 PM",
      icon: "🏥",
      urgent: true,
    },
    {
      event: "Grooming - Buddy",
      date: "Dec 28, 10:00 AM",
      icon: "✂️",
      urgent: false,
    },
    {
      event: "Training Session - Max",
      date: "Dec 30, 4:00 PM",
      icon: "🎓",
      urgent: false,
    },
    {
      event: "Vaccination Due - Whiskers",
      date: "Jan 5, 2024",
      icon: "💉",
      urgent: true,
    },
            ...
            <CardContent>
              <div className="space-y-3">
                {upcomingEvents.map((event, index) => (
                  <div
                    key={index}
                    className={`p-3 rounded-lg border-l-4 ${event.urgent ? "border-l-red-400 bg-red-50" : "border-l-blue-400 bg-blue-50"}`}
                  >
          ...
          <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-3">
                <Button
                  asChild
                  className="h-20 flex-col gap-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700"
                >
                  <Link to="/reminders">
