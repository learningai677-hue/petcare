  ...
  useEffect(() => {
    ...
    setRecords([
      ...
      },
      {
        ...
        description:
          "General health examination, weight check, dental inspection",
        date: "2024-01-10",
      ...
      <div className="relative z-10 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Track your pet's health history and veterinary care
          </p>
        </div>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${typeColors[record.type]} flex items-center justify-center`}
                  >
