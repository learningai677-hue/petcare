            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value: ExerciseSession["activityType"]) =>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Select
                  ...
                  onValueChange={(value: ExerciseSession["intensity"]) =>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${activityColors[session.activityType]} flex items-center justify-center`}
                  >
        ...
        {sessions.length === 0 && (
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 text-lg">
                No exercise sessions logged yet. Start tracking your pet's
                activity!
              </p>
            </CardContent>
          </Card>
