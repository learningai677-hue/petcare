            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value: GroomingSession["serviceType"]) =>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <Input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, groomer: e.target.value })
                  }
                  required
                />
                <Input
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${serviceColors[session.serviceType]} flex items-center justify-center`}
                  >
                    <span className="text-white text-lg">
                      {serviceIcons[session.serviceType]}
                    </span>
                  </div>
                  <div className="flex-1">
                    ...
                    {session.nextDue && (
                      <p className="text-orange-600 mb-2">
                        ...
                        {new Date(session.nextDue).toLocaleDateString()}
                      </p>
                    )}
        ...
        {sessions.length === 0 && (
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 text-lg">
                No grooming sessions logged yet. Start tracking your pet's
                beauty care!
              </p>
            </CardContent>
          </Card>
