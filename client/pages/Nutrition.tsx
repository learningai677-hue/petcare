      ...
      <div className="relative z-10 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Monitor your pet's diet, weight, and nutritional health
          </p>
        </div>
              ...
              <CardContent>
                <form onSubmit={handleFeedingSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    />
                    <Select
                      value={feedingForm.mealType}
                      onValueChange={(value: NutritionEntry["mealType"]) =>
                        setFeedingForm({ ...feedingForm, mealType: value })
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Select
                      ...
                      onValueChange={(value: NutritionEntry["unit"]) =>
                        setFeedingForm({ ...feedingForm, unit: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                ...
                >
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4 mb-4">
                      <div
                        className={`w-12 h-12 rounded-xl bg-gradient-to-r ${mealTypeColors[entry.mealType]} flex items-center justify-center`}
                      >
                ...
                <form onSubmit={handleWeightSubmit} className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <Select
                      ...
                      onValueChange={(value: WeightEntry["unit"]) =>
                        setWeightForm({ ...weightForm, unit: value })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
        ...
        {((activeTab === "feeding" && nutritionEntries.length === 0) ||
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 text-lg">
                No{" "}
                {activeTab === "feeding" ? "feeding entries" : "weight records"}{" "}
                yet. Start tracking above!
              </p>
            </CardContent>
          </Card>
        )}
