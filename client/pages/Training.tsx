      ...
      <div className="relative z-10 p-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Track your pet's training progress and skills development
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value: TrainingSession["difficulty"]) =>
                ...
                <div className="flex items-center gap-4">
                  <label className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, success: e.target.checked })
                      }
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-start gap-4 mb-4">
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-r ${difficultyColors[session.difficulty]} flex items-center justify-center`}
                  >
        ...
        {sessions.length === 0 && (
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 text-lg">
                No training sessions logged yet. Start tracking your pet's
                progress!
              </p>
            </CardContent>
          </Card>
