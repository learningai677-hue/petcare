    ...
    setProfiles([
      {
        ...
        age: 3,
        imageBase64:
          "https://images.pexels.com/photos/31246311/pexels-photo-31246311.jpeg",
      },
    ]);
  }, []);
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            Create & manage profiles with photos & details for all your beloved
            pets
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {profiles.map((profile) => (
            <Card
              key={profile.id}
              className="bg-white/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden"
            >
          ...
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="text-center py-12">
              ...
              <p className="text-gray-600 text-lg">
                No pet profiles yet. Add your first pet profile above!
              </p>
            </CardContent>
          </Card>
        )}
