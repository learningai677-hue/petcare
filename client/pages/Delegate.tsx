...
export default function Delegate() {
    ...
    setRequests([
      {
        ...
        petName: 'Max',
        careDetails: 'Need someone to walk my dog twice daily and feed him. He loves playing fetch!',
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setFormData({ ownerName: '', petName: '', careDetails: '', startDate: '', endDate: '' });
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-red-50">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <Link to="/" className="inline-flex items-center text-rose-600 hover:text-rose-800 mb-6 transition-colors">
            ← Back to Home
          </Link>
        ...
        <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl mb-8 max-w-2xl mx-auto">
          <CardHeader>
            <CardTitle className="text-center text-2xl">Post Help Request</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Textarea
                ...
                onChange={(e) => setFormData({...formData, careDetails: e.target.value})}
                required
                rows={3}
              />
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Button type="submit" className="w-full bg-gradient-to-r from-rose-500 to-red-600 hover:from-rose-600 hover:to-red-700">
                Post Help Request
              </Button>
            </form>
          </CardContent>
        ...
        {/* Help Requests List */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">Open Help Requests</h2>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {requests.map((request) => (
              <Card key={request.id} className="bg-white/90 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3 mb-4">
                    <p className="text-gray-700">
                      <span className="font-medium">Care needed:</span> {request.careDetails}
                    </p>
                    <p className="text-gray-700">
                    ...
                    <p className="text-gray-700">
                      <span className="font-medium">Volunteers:</span> {request.volunteers.length}
                      {request.volunteers.length > 0 && (
                        <span className="text-sm text-gray-600"> ({request.volunteers.join(', ')})</span>
                      )}
                    </p>
                  </div>
        ...
        {requests.length === 0 && (
          <Card className="bg-white/90 backdrop-blur-sm border-0 shadow-xl">
            <CardContent className="text-center py-12">
              ...
              />
              <p className="text-gray-600 text-lg">No open requests currently. Post the first one above!</p>
            </CardContent>
          </Card>
        )}
